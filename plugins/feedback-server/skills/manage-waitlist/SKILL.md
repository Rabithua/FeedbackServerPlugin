...
code and triggers OAuth once. A same-browser handoff loads the invitation automatically; show the code
only when an isolated browser asks for it. The recipient reviews the recognized invitation and accepts
